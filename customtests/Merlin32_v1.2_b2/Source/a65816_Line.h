...
struct source_line
{
  ...
  int is_fixed_address;          /* Cette ligne a une adresse fixe (cas des lignes situées dans [ORG $Addr ORG] pour un OMF ou un Single Binary */
  int global_bank;
  ...
  int alignment;                 /* Alignement pour les DS \SIZE et ORG \SIZE */
