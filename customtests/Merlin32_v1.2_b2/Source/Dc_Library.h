...
#define FILE_INIT_DIRECTORY             1
#define FILE_CLOSE_DIRECTORY            2
#define FILE_DECLARE_DIRECTORY          3
#define FILE_FREE_DIRECTORY             4
...
#define MEMORY_SET_SOURCE_FILE         15
#define MEMORY_GET_SOURCE_FILE         16
#define MEMORY_FREE_SOURCE_FILE        17

#define MEMORY_SET_CURR_ERROR_SEGMENT  18
#define MEMORY_GET_CURR_ERROR_SEGMENT  19
...
struct parameter
{
  ...
  char macro_folder_path[1024];     /* Dossier où se trouve les fichiers Macro */

  char project_folder_path[1024];   /* Dossier où se trouvait le fichier Link ou le Master Source File => Sert de current path pour les fichiers ASM ou DSK */
...
void BuildOutputFolderPath(char *,char *);
char *BuildProjectFileName(char *);
char *BuildProjectFilePath(char *,char *);
void BuildAbsolutePath(char *,char *,char *);
int IsAbsolutePath(char *);
void CleanUpFilePath(char *);
void mem_free_list(int,char **);
struct parameter *mem_alloc_param(char *);
